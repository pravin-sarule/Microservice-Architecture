...
//             // If no plan returned, assign default Free Plan
//             if (!userPlan) {
//                 userPlan = {
//                     id: 'default-free-plan',
//                     name: 'Free Plan',
...
//                     carry_over_limit: 0,
//                     interval: 'monthly',
//                     token_renew_interval_hours: DEFAULT_TOKEN_RENEWAL_INTERVAL_HOURS
//                 };
//             }

//             // Ensure interval mapping matches database logic
//             const intervalMap = {
//                 'day': 'daily',
//                 'week': 'weekly',
//                 'month': 'monthly',
...
//             // Calculate period aligned with IST, store UTC
//             const nowUTC = moment.utc();
//             const nowIST = nowUTC.clone().tz(TIMEZONE);
//             let periodStart, periodEnd;
...
//         } catch (err) {
//             console.error('❌ Error in getUserUsageAndPlan:', err.response?.data || err.message);
//             throw err;
//         } finally {
//             if (client) client.release();
//         }
...
//     // --- Enforce token limits and cooldown ---
//     static async enforceLimits(userId, userUsage, userPlan, requestedResources = {}) {
//         const nowUTC = moment.utc();
//         const nowIST = nowUTC.clone().tz(TIMEZONE);
...
//         // Use plan-specific token renewal interval if provided
...
//             } catch (err) {
//                 console.warn(`⚠️ Could not fetch plan for user ${userId}, using default Free Plan`);
//                 userPlan = {
//                     id: 'default-free-plan',
//                     name: 'Free Plan',
//                     token_limit: 25000,
...
//         // --- Only block if requested tokens exceed available tokens ---
//         if (requestedTokens > availableTokens) {
//             const exhaustionUTC = nowUTC.toISOString();
//             await this.updateLastGrant(userId, exhaustionUTC);
